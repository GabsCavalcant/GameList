...
import com.gabsprojeto.gamelist.dto.ReplacmenteDto;
...
public class GameListController {
	...
	public void move(@PathVariable Long listId, @RequestBody ReplacmenteDto body){
		
		gameListService.move(listId, body.getSourceIndex(), body.getDestination());
